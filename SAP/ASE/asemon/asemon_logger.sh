...
export CLASSPATH=$ASEMON_LOGGER_HOME/dist/Asemon_logger_V3.jar:$ASEMON_LOGGER_HOME/lib/jdom.jar:$ASEMON_LOGGER_HOME/lib/xerces.jar:$ASEMON_LOGGER_HOME/lib/java-getopt-1.0.9.jar:$JCONNECT_HOME/classes/jconn4.jar:$JCONNECT_HOME/classes/jTDS3.jar
